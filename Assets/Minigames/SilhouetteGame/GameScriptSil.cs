...
public class GameScriptSil : MonoBehaviour {
	
	public ScoreboardSil scoreboard;
	...
	void Update()
	{
		...
		if (canWin == 2)
		{
			...
			ResourcePackSil resourceMenuScript = resourcePackMenu.GetComponent("ResourcePackSil") as ResourcePackSil;
		...
		else
		{
			...
			if (Physics.Raycast(ray, out hit))
			{
				...
				{
					MoverSil mover = hit.collider.gameObject.GetComponent("MoverSil") as MoverSil;
					...
					else
					{
						...
						{
							mover = first.GetComponent("MoverSil") as MoverSil;
							mover.MoveDown();
						}
	...
	{
		MoverSil mover1 = first.GetComponent("MoverSil") as MoverSil;
		MoverSil mover2 = second.GetComponent("MoverSil") as MoverSil;
